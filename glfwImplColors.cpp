...
ImplCallback g_implColors = {getUserData, setWindow, onInit, onRender, onKeyCallback};
...
static const char* lampVertShaderSource = objectVertShaderSource;
...
//    glBindVertexArray(0);
    ...
    if(!d.mLampShader.ready)
        return ret;
    d.lightPos = glm::vec3(1.2f, 1.0f, 2.0f);
