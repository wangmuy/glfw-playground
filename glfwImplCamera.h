//
// Created by wangmuy on 2017/5/16.
//

#ifndef GLITTER_GLFWIMPLCAMERA_H
#define GLITTER_GLFWIMPLCAMERA_H
...
// Defines several possible options for camera movement. Used as abstraction to stay away from window-system specific input methods
    ...
    const GLfloat MOVESENSITIVTY =  0.1f;
    const GLfloat ZOOM       =  45.0f;
    const GLfloat SCROLLSENSITIIVTY = 0.05f;
...
#endif //GLITTER_GLFWIMPLCAMERA_H
